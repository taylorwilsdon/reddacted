    ...
    def create_completion_panel(
        ...
        return Panel(
            Text.assemble(
                ...
                ("🗒️  Total comments: ", "bold blue"), (f"{total_comments}\n", "bold cyan"),
                ("🔐 PII detected in: ", "bold blue"), (f"{total_pii_comments} ", "bold red"),
                (f"({total_pii_comments/total_comments:.1%})\n", "dim"),
                ("🤖 LLM findings in: ", "bold blue"), (f"{total_llm_pii_comments} ", "bold magenta"),
